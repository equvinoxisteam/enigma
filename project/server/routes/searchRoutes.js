...
router.get('/recommendations', protect, requireFeature(FEATURE_KEYS.AI_SEARCH), getRecommendationsController);
router.get('/ai', protect, requireFeature(FEATURE_KEYS.AI_SEARCH), aiSearchController);
